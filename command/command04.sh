...
grep -v "^#" ~/exercise02/data/d_melanogaster.genes.gtf | awk '$3 == "gene" && $11 == "gene_name" && $12 ~ /Raf/ {print $0}' > ~/exercise02/result/result04_2.txt
...
grep -v "^#" ~/exercise02/data/d_melanogaster.genes.gtf | awk -F "\t" '$3=="transcript" && $9~"Raf" {print $9}' | tr -d "\";" | awk '{print $12}' > ~/exercise02/result/result04_3.txt
...
grep -v "^#" ~/exercise02/data/d_melanogaster.genes.gtf | awk -F "\t" '$3=="exon" && $9~"Raf" {print $9}' | tr -d "\";" | awk '{print $14}' | sort | uniq -c | awk '{print $2","$1}' > ~/exercise02/result/result04_4.csv
...
awk -F"\t" '$3=="exon"&&$9~"Raf" {print $5-$4+1,$9}' | tr -d "\";" | 
