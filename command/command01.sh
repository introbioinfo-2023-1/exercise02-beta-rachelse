...
wget -O ~/exercise02/data/d_melanogaster.genes.gtf.gz "ftp://ftp.ensembl.org/pub/release-103/gtf/drosophila_melanogaster/Drosophila_melanogaster.BDGP6.32.103.gtf.gz"
